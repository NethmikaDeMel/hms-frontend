...
const sheetVariants = cva(
  "bg-white fixed z-50 flex flex-col gap-4 border-slate-200/80 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
